...
const EventForm = ({userId, type, event, eventId}: EventFormProps) => {
    ...
    const initialValue = event && type === 'Update' ? {...event, startDateTime: new Date(event.startDateTime), endDateTime: new Date(event.endDateTime)}: eventDefaultValues;
        ...
        if(type === 'Update'){
          ...
          try {
            const updatedEvent = await updateEvent({
              userId, event: {...values, imageUrl: uploadedImageUrl, _id: eventId},  path:`/events/${eventId}`
            })
